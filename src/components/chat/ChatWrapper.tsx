        ...
        <div className="flex-1 flex justify-center items-center flex-col mb-28">
          <div className="flex flex-col items-center gap-2">
            ...
            <p className="text-zinc-500 text-sm">
              Your <span className="font-medium">{isSubscribed ? "Pro" : "Free"}</span> plan supports up to {isSubscribed ? PLANS.find((p) => p.name === "Pro")?.pagesPerPdf : PLANS.find((p) => p.name === "Free")?.pagesPerPdf} pages per PDF.
            </p>
            <Link
              href="/dashboard"
